            ...
            if ((world.getBlock(x, y, z) instanceof BlockSpeaker)) {
                ...
                if (boundSpeakers.get(stack) != null) {
                    ...
                    if (canAdd == 0) {
                        ...
                        PacketHandler.INSTANCE.sendToServer(new MessageTERadioBlock(x, y, z, world, radio.getStreamURL(), radio.isPlaying(), radio.getVolume(), 15, speaker.x, speaker.y, speaker.z));
                    } else if (canAdd == 1) {
