...
public class GuiRadio extends GuiRadioBase {
	...
	public void updateScreen()
	{
		...
		if ((this.radio.isListeningToRedstoneInput() & !this.redstoneButtonState)) {
			...
			this.redstoneBtn = new OFMGuiButton(11, this.width / 2 + 100 - 13, this.height / 2 + 3 - 5 - 45, 8, 8, 95, 24, "", OFMGuiButton.guiLocation);
			this.OFMbuttonList.add(this.redstoneBtn);
		}
		if ((!this.radio.isListeningToRedstoneInput() & this.redstoneButtonState)) {
			this.redstoneButtonState = false;
			this.OFMbuttonList.remove(this.redstoneBtn);
			this.redstoneBtn = new OFMGuiButton(11, this.width / 2 + 100 - 13, this.height / 2 + 3 - 5 - 45, 8, 8, 87, 24, "", OFMGuiButton.guiLocation);
			this.OFMbuttonList.add(this.redstoneBtn);
		}
		if ((this.radio.isLocked & !this.lockedButtonState)) {
			this.lockedButtonState = true;
			this.OFMbuttonList.remove(this.lockedBtn);
			this.lockedBtn = new OFMGuiButton(12, this.width / 2 + 100 - 4, this.height / 2 + 30 - 45, 12, 16, 103, 24, "", OFMGuiButton.guiLocation);
			this.OFMbuttonList.add(this.lockedBtn);
		}
		if ((!this.radio.isLocked & this.lockedButtonState)) {
			this.lockedButtonState = false;
			this.OFMbuttonList.remove(this.lockedBtn);
			this.lockedBtn = new OFMGuiButton(12, this.width / 2 + 100 - 4, this.height / 2 + 30 - 45, 12, 16, 115, 24, "", OFMGuiButton.guiLocation);
			this.OFMbuttonList.add(this.lockedBtn);
		}
